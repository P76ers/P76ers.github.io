...
<CardChapter>
  ...
  - Wordwrapping
    ...
    <CardInfo
      title='Info:'
      icon={<MyInfoIcon />}
      description='Add an empty line between elements.'
    />
...
<CardHeading>
  ...
  <CardDanger
    title='Danger:'
    icon={<MyDangerIcon />}
    description='Not all extended syntax features work in all markdown applications.'
  />
...
<CardChapter>
  ...
  <CardInfo
    title='Info:'
    icon={<MyInfoIcon />}
    description='Footnote is at bottom of Page!'
  />
