...
/* harmony import */ var _default_ui_config_17016dd5_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(88841);
/* harmony import */ var _index_330fca84_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(62292);
/* harmony import */ var _config_1665d778_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(24335);
...
/* harmony import */ var _default_language_355974c8_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(60368);
...
const getIconPack = async (url) => {
  ...
  if (url == null) {
    return _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  try {
    ...
    return Object.assign({}, _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_3__.d, await res.json());
  }
  catch (_) {
    return _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.language = 'en';
    /** UI Config */
    this.config = _default_ui_config_17016dd5_js__WEBPACK_IMPORTED_MODULE_4__.d;
    this.states = {
      meeting: 'idle',
      prefs: {
        mirrorVideo: true,
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_1665d778_js__WEBPACK_IMPORTED_MODULE_6__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  disconnectedCallback() {
    ...
    (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self.removeListener('roomLeft', this.roomLeftListener);
    (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self.removeListener('waitlisted', this.waitlistedListener);
    (_d = this.meeting) === null || _d === void 0 ? void 0 : _d.self.removeListener('mediaPermissionError', this.mediaPermissionErrorListener);
    (_e = this.meeting) === null || _e === void 0 ? void 0 : _e.self.removeListener('joinStageRequestAccepted', this.joinStateAcceptedListener);
  }
    ...
    if (meeting != null) {
      if (this.loadConfigFromPreset && meeting.self.suggestedTheme != null) {
        ...
        const { config, data } = (0,_versionTwoApis_04d51844_js__WEBPACK_IMPORTED_MODULE_9__.i)(theme)
          ? { config: _default_ui_config_17016dd5_js__WEBPACK_IMPORTED_MODULE_4__.d, data: { showSetupScreen: true } }
          : (0,_config_1665d778_js__WEBPACK_IMPORTED_MODULE_6__.g)(theme);
        if (this.config === _default_ui_config_17016dd5_js__WEBPACK_IMPORTED_MODULE_4__.d) {
  ...
  async languageChanged(lang) {
    this.t = (0,_index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_2__.u)(await (0,_index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_2__.g)(lang));
  }
  listenState(e) {
    e.stopPropagation();
