...
const DyteGridPagination = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      ...
      participants.joined.addListener('participantJoined', this.onParticipantUpdate);
      participants.joined.addListener('participantLeft', this.onParticipantUpdate);
      this.onParticipantUpdate();
    }
  }
  render() {
