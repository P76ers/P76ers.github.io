...
/* harmony import */ var _index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33565);
/* harmony import */ var _date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(72729);
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(40348);
/* harmony import */ var _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67393);
/* harmony import */ var _file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(39577);
/* harmony import */ var _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(79781);
/* harmony import */ var _default_language_355974c8_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(60368);
...
const DyteEmojiPicker = class {
  constructor(hostRef) {
    ...
    /** Language */
    this.t = (0,_index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_1__.u)();
    this.filterVal = '';
    this.filteredEmojis = [];
  }
  componentWillLoad() {
...
const ChatHead = ({ name, time, now }) => {
  return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "head" },
    (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.s)((0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.f)(name), 20)),
...
const DyteFileMessage = class {
  constructor(hostRef) {
    ...
    /** Icon pack */
    this.iconPack = _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_2__.d;
  }
  render() {
    const link = (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.a)(this.message.link);
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.isContinued && ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(ChatHead, { name: this.message.displayName, time: this.message.time, now: this.now })), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body", part: "body" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "file" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "file-data" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, this.message.name), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "file-data-split" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ext" }, (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.message.name)), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "divider" }), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "size" }, (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.a)(this.message.size)))), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", onClick: () => (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.d)(link, { name: this.message.name, fallbackName: 'file' }), part: "button" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.download }))))));
  }
};
...
const DyteImageMessage = class {
  ...
  render() {
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.isContinued && ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(ChatHead, { name: this.message.displayName, time: this.message.time, now: this.now })), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body", part: "body" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { image: true, loaded: this.status === 'loaded' } }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.a)(this.message.link), onLoad: () => {
        this.status = 'loaded';
      }, onError: () => {
        this.status = 'errored';
      }, onClick: () => {
        ...
        this.stateUpdate.emit({ image: this.message });
        _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.image = this.message;
      } }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.full_screen_maximize })), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "action", variant: "secondary", kind: "icon", onClick: () => (0,_file_52683cc2_js__WEBPACK_IMPORTED_MODULE_7__.d)(this.message.link, { fallbackName: 'image' }) }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.download }))))))));
  }
};
...
const DyteTextMessage = class {
  ...
  render() {
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.isContinued && ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(ChatHead, { name: this.message.displayName, time: this.message.time, now: this.now })), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "body", part: "body" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { text: true, emoji: (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.message.message) } }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(TextMessageView, { message: this.message.message })))));
  }
};
...
/* harmony export */ });
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40348);
...
const downloadFile = async (link, options) => {
  link = (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_0__.a)(link);
