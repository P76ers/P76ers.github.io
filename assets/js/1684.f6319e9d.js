...
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(40348);
/* harmony import */ var _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67393);
/* harmony import */ var _index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(33565);
/* harmony import */ var _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(79781);
/* harmony import */ var _default_ui_config_17016dd5_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(88841);
/* harmony import */ var _index_96b0df1d_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(72559);
/* harmony import */ var _commonjsHelpers_9943807e_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(41969);
/* harmony import */ var _default_language_355974c8_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(60368);
...
const DyteNotifications = class {
  constructor(hostRef) {
    ...
    /** Config object */
    this.config = _default_ui_config_17016dd5_js__WEBPACK_IMPORTED_MODULE_6__.d;
    /** Language */
    this.t = (0,_index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_4__.u)();
    /** Icon pack */
    this.iconPack = _default_icon_pack_35359343_js__WEBPACK_IMPORTED_MODULE_3__.d;
    this.notifications = [];
  ...
  meetingChanged(meeting) {
    ...
    if (meeting != null) {
      ...
      this.participantJoinedListener = (participant) => {
        if (this.permissions.notifications.participant_joined) {
          this.add({
            ...
            message: `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_10__.f)(participant.name)} just joined`,
      ...
      this.participantLeftListener = (participant) => {
        if (this.permissions.notifications.participant_left) {
          this.add({
            ...
            message: `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_10__.f)(participant.name)} left`,
            image: participant.picture,
            duration: 2100,
          });
        }
      ...
      this.waitlistedParticipantJoinedListener = (participant) => {
        ...
        this.add({
          id,
          message: `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_10__.f)(participant.name)} is requesting to join the meeting`,
          image: participant.picture,
          ...
          if (message.type === 'text') {
            if (this.permissions.notifications.chat) {
              this.add({
                id: `message-${Math.random().toString(36)}`,
                icon: this.iconPack.chat,
                message: `${message.displayName}: ${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_10__.s)(message.message, 20)}`,
                duration: DEFAULT_NOTIFICATION_DURATION,
              });
            }
      ...
      this.networkUpdateListener = ({ event }) => {
        ...
        if (event === 'disconnected') {
          ...
          this.disconnectTimeout = setTimeout(() => {
            ...
            _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_5__.s.roomLeftState = 'disconnected';
            ...
            button: {
              ...
              onClick: async () => {
                await this.meeting.participants.acceptAllRequestToJoinStageRequests([
                  {
                    id: request.id,
                    requestToJoinType: request.requestToJoinType,
                  },
                ]);
                this.remove(`webinar-request-${request.id}`);
              },
            },
          });
