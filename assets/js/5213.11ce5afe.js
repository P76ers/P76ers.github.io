...
/* harmony import */ var _string_133d57e8_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(40348);
/* harmony import */ var _index_a0390d0a_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33565);
/* harmony import */ var _default_language_355974c8_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60368);
...
const DyteNameTag = class {
  ...
  formatNameTag(name, isSelf) {
    return !this.isScreenShare
      ? isSelf
        ? `${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_3__.s)(name, this.length - 3)} (${this.t('you')})`
        : (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_3__.s)(name, this.length)
      : isSelf
        ? `${this.t('Screen')} - ${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_3__.s)(name, this.length - 3)} (${this.t('you')})`
        : `${this.t('Screen')} - ${(0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_3__.s)(name, this.length)}`;
  }
  render() {
    var _a, _b, _c;
    const name = (0,_string_133d57e8_js__WEBPACK_IMPORTED_MODULE_3__.f)(((_a = this.participant) === null || _a === void 0 ? void 0 : _a.name) || '');
